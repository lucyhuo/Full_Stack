    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CabsBookingDbContext>(
                   options => options.UseSqlServer(Configuration.GetConnectionString("CabsBookingBdConnection"))
               );
            ...
            services.AddScoped<IPlacesService, PlaceService>();
            services.AddScoped<IBookingsRepository, BookingsRepository>();
            services.AddScoped<IBookingsService, BookingsService>();
            services.AddScoped<IBookingsHistoriesRepository, BookingsHistoriesRepository>();
            services.AddScoped<IBookingsHistoriesService, BookingsHistoriesService>();
