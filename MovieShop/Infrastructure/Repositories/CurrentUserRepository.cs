...
namespace Infrastructure.Repositories
{
    public class CurrentUserRepository : ICurrentUserRepository
    {
        ...
        public Task<IEnumerable<Movie>> GetUserFavoritedMovies(int id)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Movie>> GetUserPurchasedMovies(int id)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Movie>> GetUserReviewdMovies(int id)
        {
            throw new NotImplementedException();
        }
